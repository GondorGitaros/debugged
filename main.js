...
function add(a, b) {
  // your code here...
		...
		setup: function (scene) {
			...
			if (!scene.textures.exists("winBlock")) {
				const winGfx = scene.add.graphics();
				winGfx.fillStyle(0xffff00, 1);
				winGfx.fillRect(0, 0, 50, 50);
				winGfx.generateTexture("winBlock", 50, 50);
				winGfx.destroy();
			}
